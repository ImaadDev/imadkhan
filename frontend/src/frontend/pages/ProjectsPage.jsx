  ...
  const projects = [
    {
      ...
      category: 'fullstack',
      description: 'Complete MERN stack e-commerce solution with advanced features',
      longDescription: 'A comprehensive e-commerce platform built with React, Node.js, Express, and MongoDB. Features include user authentication, payment processing, inventory management, and admin dashboard.',
      ...
      status: 'completed',
      featured: true,
      stats: { stars: 245, forks: 89, commits: 342 }
    },
    {
      id: 2,
      title: 'Real-Time Chat App',
      category: 'fullstack',
      description: 'Socket.io powered chat application with rooms and file sharing',
      longDescription: 'Modern real-time chat application with private messaging, group chats, file sharing, and emoji support. Built with React and Socket.io.',
      tech: ['React.js', 'Socket.io', 'Node.js', 'MongoDB', 'Cloudinary'],
      image: '/api/placeholder/600/400',
      github: 'https://github.com/user/chat-app',
      live: 'https://chat-app-demo.com',
      status: 'completed',
      featured: true,
      stats: { stars: 189, forks: 67, commits: 203 }
    },
    {
      id: 3,
      title: 'Task Management System',
      category: 'frontend',
      description: 'Kanban-style project management tool with drag & drop',
      longDescription: 'Advanced task management system with drag-and-drop functionality, team collaboration features, and detailed analytics.',
      ...
      status: 'completed',
      featured: false,
      stats: { stars: 156, forks: 42, commits: 187 }
    },
    {
      id: 4,
      ...
      longDescription: 'Scalable API gateway built with Node.js and Express, featuring rate limiting, authentication, load balancing, and comprehensive logging.',
      ...
      status: 'in-progress',
      featured: true,
      stats: { stars: 298, forks: 123, commits: 456 }
    },
    {
      id: 5,
      title: 'Data Visualization Dashboard',
      category: 'frontend',
      description: 'Interactive analytics dashboard with D3.js charts',
      longDescription: 'Beautiful data visualization dashboard with interactive charts, real-time updates, and customizable widgets for business analytics.',
      tech: ['React.js', 'D3.js', 'Chart.js', 'TypeScript', 'Tailwind CSS'],
      image: '/api/placeholder/600/400',
      github: 'https://github.com/user/dashboard',
      live: 'https://dashboard-demo.com',
      status: 'completed',
      featured: false,
      stats: { stars: 134, forks: 56, commits: 234 }
    },
    {
      id: 6,
      ...
      longDescription: 'Secure and transparent voting system built on blockchain technology with smart contracts and decentralized architecture.',
      tech: ['React.js', 'Solidity', 'Web3.js', 'Node.js', 'Ethereum'],
      image: '/api/placeholder/600/400',
      github: 'https://github.com/user/blockchain-voting',
      live: 'https://voting-demo.com',
      status: 'completed',
      featured: true,
      stats: { stars: 412, forks: 156, commits: 523 }
    }
  ];
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-8">
        ...
        <div className={`transform transition-all duration-1000 delay-1000 mt-20 text-center ${
          ...
          <div className="border-2 border-green-400/30 p-8 bg-gray-900/30">
            <h3 className="text-2xl font-bold text-green-400 mb-4">INTERESTED IN COLLABORATION?</h3>
